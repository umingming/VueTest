export const QUESTIONS = [
	...
	{
		ANSWER: 3,
		QUESTION: `어떤 모듈이 다른 모듈의 내부 논리 조직을 제어하기 위한 목적으로 제어 신호를 리용하여 통신하는 경우이며, 하위 모듈에서 상위 모듈로 제어 신호가 이동하여 상위 모듈에게 처리 명령을 부여하는 권리 전도 현상이 발생하게 되는 결합도는?\r\n1)data coupling    2)stamp coupling    3)control coupling    4)common coupling\r\n`,
		ITERATION: 202008,
		NO: 77,
		IS_CORRECT: false,
		IS_ENTERED: false,
	...
	{
		ANSWER: 14,
		QUESTION: `페이지 참조 열 [7, 0, 1, 2, 0, 3, 0, 4, 2, 3, 0, 3, 2, 1, 2, 0, 1, 7, 0]에 대해 페이지 교체 기법으로 선입선출 알고리즘을 사용할 경우 페이지 부재 횟수는? (단, 할당된 페이지 프레임의 수는 3이고, 처음에는 모든 프레임이 비어 있음.)\r\n-> ㅇㅇ\r\n`,
		ITERATION: 202006,
		NO: 77,
		IS_CORRECT: false,
		IS_ENTERED: false,
