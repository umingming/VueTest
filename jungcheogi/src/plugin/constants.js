export const QUESTIONS = [
	...
	},
	{
		ANSWER: "파이프 필터",
		QUESTION:
			"서브 시스템이 입력 데이터를 받아 처리하고 결과를 다른 시스템에 보내는 작업이 반복되는 아키텍처 스타일은?\r\n-> ㅇㅇㅇ ㅇㅇ 구조\r\n",
		ITERATION: 202105,
		NO: 12,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	{
		ANSWER: "액터, 객체, 라이프, 실행, 메시지, 소멸, 프레임",
		QUESTION:
	...
	},
	{
		ANSWER: "기능",
		QUESTION:
			"럼바우의 객체 지향 분석 기법 중 자료 흐름도(DFD)를 주료 이용하는 것은?\r\n-> ㅇㅇ모델링\r\n",
		ITERATION: 202108,
		NO: 15,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "객체지향",
		QUESTION:
			"ㅇㅇㅇㅇ 분석; 소프트웨어를 개발하기 위한 비즈니스를 객체와 속성, 클래스와 멤버, 전체와 부분 등으로 나누어서 분석해 내는 기법\r\n",
		ITERATION: 202103,
		NO: 17,
		IS_CORRECT: "X",
		SUBJECT: 1,
	},
	{
		ANSWER: "송신",
		QUESTION:
			"시스템 인터페이스를 구성하는 시스템으로, 연계할 데이터를 데이터베이스와 애플리케이션으로부터 연계 테이블 또는 파일 형태로 생성하여 송신하는 시스템이란?\r\n-> ㅇㅇ 시스템\r\n",
		ITERATION: 202105,
		NO: 9,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "소켓",
		QUESTION:
			"통신을 위한 프로그램을 생성하여 포트를 할당하고, 클라이언트의 통신 요청 시 클라이언트와 연결하는 내/외부 송/수신 연계 기술은?\r\n-> ㅇㅇ 기술\r\n",
		ITERATION: 202103,
		NO: 2,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"럼바우 분석기법에서 정보 모델링이라고도 하며, 시스템에서 요구되는 객체를 찾아내어 속성과 연산 식별 및 객체들 간의 관계를 규정하여 다이어그램을 표시하는 모델링은?\r\n1)Object 2)Dynamic 3)Function 4)Static\r\n",
		ITERATION: 202103,
		NO: 16,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "ㄹㄴㄷㄱ",
		QUESTION:
			"요구사항 개발 프로세스의 순서는?              정답 기입 예시)ㄱㄴㄷㄹ\r\nㄱ)확인 ㄴ)분석 ㄷ)명세 ㄹ)도출                   \r\n",
		ITERATION: 202105,
		NO: 3,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "미들",
		QUESTION:
			"ㅇㅇ웨어; 클라이언트와 서버 간의 통신을 담당하는 시스템 소프트웨어\r\n",
		ITERATION: 202009,
		NO: 18,
		IS_CORRECT: "X",
		SUBJECT: 1,
	},
	{
		ANSWER: "캡슐",
		QUESTION:
			"객체 지향 설계에서 객체가 가지고 있는 속성과 오퍼레이션의 일부를 감추어서 객체의 외부에서 접근이 불가능하게 하는 개념은?\r\n-> ㅇㅇ화\r\n",
		ITERATION: 202105,
		NO: 5,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: 3,
		QUESTION:
			"코드화 대상 항목의 증량, 면적, 용량 등의 물리적 수치를 이용하여 만든 코드는?\r\n1)순차 코드 2)10진 코드 3)표의 숫자 코드 4)블록 코드\r\n",
		ITERATION: 202009,
		NO: 7,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "순차",
		QUESTION:
			"ㅇㅇ 코드; 코드 설계에서 일정한 일련 번호를 부여하는 방식의 코드\r\n",
		ITERATION: 202006,
		NO: 1,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	{
		ANSWER: "클래스",
		QUESTION: "ㅇㅇㅇ; 객체 지향 프로그램에서 데이터를 추상화하는 단위\r\n",
		ITERATION: 202006,
		NO: 3,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: 4,
		QUESTION:
			"UML에서 활용되는 다이어그램 중, 시스템의 동작을 표현하는 행위 다이어그램에 해당하지 않는 것은?\r\n1)유스케이스 다이어그램 2)시퀀스 다이어그램 3)활동 다이어그램 4)배치 다이어그램 \r\n",
		ITERATION: 202008,
		NO: 12,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "상태",
		QUESTION:
			"ㅇㅇ 다이어그램: 럼바우의 객체지향 분석 기법에서 동적 모델링에 활용됨.\r\n",
		ITERATION: 202009,
		NO: 2,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "확장",
		QUESTION:
			"ㅇㅇ 유스케이스: 기본 유스케이스 수행 시 특별한 조건을 만족할 때 수행\r\n",
		ITERATION: 202103,
		NO: 13,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "집단",
		QUESTION:
			"ㅇㅇ화; 객체지향 기법에서 클래스들 사이의 '부분-전체' 관계 또는 '부분'의 관계로 설명되는 연관성을 나타냄.\r\n",
		ITERATION: 202006,
		NO: 16,
		IS_CORRECT: "X",
		SUBJECT: 1,
	...
	},
	{
		ANSWER: "외계인, 스파게티",
		QUESTION:
			"ㅇㅇㅇ 코드; 아주 오래되거나 참고 문서 또는 개발자가 없어 유지보수 작업이 어려운 프로그램을 의미함.\r\nㅇㅇㅇㅇ 코드; 프로그램의 로직이 복잡하여 이해하기 어려운 프로그램을 의미함.\r\n",
		ITERATION: 202006,
		NO: 40,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	{
		ANSWER: "클리어링, 저작권자, 패키저, 분배, 소비, 컨트롤, 원본",
		QUESTION:
	...
	},
	{
		ANSWER: "3, 5, 6, 7",
		QUESTION:
			"버블 정렬을 이용하여 [9, 6, 7, 3, 5]를 오름차순으로 정렬할 경우 PASS 3의 결과는? 정답 기입 예시) 9, 6, 7, 3\r\n-> ㅇ, ㅇ, ㅇ, ㅇ, 9\r\n",
		ITERATION: 202108,
		NO: 22,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"소프트웨어 품질 목표 중 하나 이상의 하드웨어 환경에서 운용되기 위해 쉽게 수정될 수 있는 시스템의 능력은?\r\n1)Portability 2)Efficiency 3)Usability 4)Correctness\r\n",
		ITERATION: 202108,
		NO: 36,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: "8, 4, 9, 7",
		QUESTION:
			"[8, 3, 4, 9, 7]을 삽입 정렬로 오름차순 정렬할 경우 1회전 후의 결과는? 정답 기입 예시) 8, 3, 4, 9\r\n-> 3, ㅇ, ㅇ, ㅇ, ㅇ\r\n",
		ITERATION: 202009,
		NO: 27,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"소프트웨어 개발 활동을 수행함에 있어 시스템이 고장을 이르키게 하며, 오류가 있는 경우 발생하는 것은?\r\n1)Fault 2)Testcase 3)Mistake 4)Inspection\r\n",
		ITERATION: 202108,
		NO: 34,
		IS_CORRECT: "x",
		SUBJECT: 2,
	},
	{
		ANSWER: "4, 7, 9, 8",
		QUESTION:
			"Selection Sort를 사용하여 [8, 3, 4, 9, 7]을 오름차순 정렬한 경우 PASS 3의 결과는? 정답 기입 예시) 8, 3, 4, 9\r\n-> 3, ㅇ, ㅇ, ㅇ, ㅇ\r\n",
		ITERATION: 202103,
		NO: 22,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: "블랙, 블랙, 화이트, 블랙",
		QUESTION:
			"스택의 자료 삭제 알고리즘에서 괄호에 들어갈 내용은? (단, TOP: 스택포인터, S: 스택의 이름)\r\n-----------------------------------\r\nIf Top = 0 Then\r\n( )\r\nElse {\r\nremove S(Top)\r\nTop = Top - 1\r\n}\r\n",
		ITERATION: 202108,
		NO: 27,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: "17, 35, 40, 37",
		QUESTION:
			"[37, 14, 17, 40, 35]를 선택 정렬로 오름차순 정렬하고자 함. 3회전 후의 결과는? 정답 기입 예시) 37, 14, 17, 40\r\n-> 14, ㅇㅇ, ㅇㅇ, ㅇㅇ, ㅇㅇ\r\n",
		ITERATION: 202008,
		NO: 27,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: "자식, 자식",
		QUESTION:
			"깊이 우선 탐색(DFS); 정점에서 ㅇㅇ 노드 방향으로 운행하면서 형제 노드와 자식 노드가 있을 때 ㅇㅇ 노드를 우선 탐색하는 기법으로 모든 노드를 한 번씩 방문함.\r\n",
		ITERATION: 202108,
		NO: 23,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	{
		ANSWER: "정, 효, 무, 유, 이, 재사용, 운용",
		QUESTION:
			"소프트웨어 품질 측정을 위해 개발자 관점에서 고려해야할 항목은?\r\n-> ㅇ확성, 신뢰성, ㅇ율성, ㅇ결성, ㅇ연성, ㅇ식성, ㅇㅇㅇ성, 상호ㅇㅇ성\r\n",
		ITERATION: 202006,
		NO: 23,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"그래프의 특수한 형태로 노드와 선분으로 되어 있고, 정점 사이에 사이클이 형성되어 있지 않으며, 자료 사이의 관계성이 계층 형식으로 나타나는 비선형 구조는?\r\n1)tree 2)network 3)stack 4)distributed\r\n",
		ITERATION: 202103,
		NO: 25,
		IS_CORRECT: "x",
		SUBJECT: 2,
	...
	},
	{
		ANSWER: "타임스탬프",
		QUESTION:
			"ㅇㅇㅇㅇㅇ 기법; 동시성 제어를 위한 직렬화 기법으로 트랜잭션 간의 처리 순서를 미리 정하는 방법\r\n",
		ITERATION: 202108,
		NO: 58,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: 2,
		QUESTION:
			"어떤 릴레이션 R에서 X와 Y를 각각 R의 애트리뷰트 집합의 부분 집합이라고 할 경우 애트리뷰트 X의 값 각각에 대해 시간에 관계 없이 항상 애트리뷰트 Y의 값이 오직 하나만 연관되어 있을 때 Y는 X에 함수 종속이라고 함. 이 함수 종속의 표기로 옳은 것은?\r\n1)Y → X    2)X → Y    3)Y ⊂ X    4)X ⊂ Y\r\n",
		ITERATION: 202108,
		NO: 60,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: 3,
		QUESTION:
			"DDL의 명령어 중 스키마, 도메인, 인덱스 등을 정의할 때 사용하는 SQL문은?\r\n1)ALTER    2)SELECT    3)CREATE    4)INSERT\r\n",
		ITERATION: 202105,
		NO: 45,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: "개체",
		QUESTION:
			"ㅇㅇ 무결성; 기본 키를 구성하는 속성은 Null 값이나 중복 값을 가질 수 없다는 제약 조건\r\n",
		ITERATION: 202105,
		NO: 48,
		IS_CORRECT: "x",
		SUBJECT: 3,
	},
	{
		ANSWER: "10, 35",
		QUESTION:
			"릴레이션 R의 차수가 4이고 카디널리티가 5이며, 릴레이션 S의 차수가 6이고 카디널리티가 7일 때, 두 개의 릴레이션을 카티션 프로덕트한 결과의 새로운 릴레이션의 차수와 카디널리티는 얼마인가?                                정답 기입 예시) 45, 67\r\n-> 차수: ㅇㅇ, 카디널리티: ㅇㅇ\r\n",
		ITERATION: 202105,
		NO: 53,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: "개념",
		QUESTION:
			"ㅇㅇ 스키마; 데이터베이스 전체를 정의한 것으로 데이터 개체, 관계, 제약 조건, 접근 권한, 무결성 규칙 등을 명세한 것\r\n",
		ITERATION: 202103,
		NO: 42,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"조건을 만족하는 릴레이션의 수평적 부분 집합으로 구성하며, 연산자의 기호는 그리스 문자 시그마(σ)를 사용하는 관계 대수 연산은?\r\n1)Select    2)Project    3)Join    4)Division\r\n",
		ITERATION: 202103,
		NO: 51,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: "인덱스",
		QUESTION:
			"ㅇㅇㅇ; 데이터베이스 성능에 많은 영향을 주는 DBMS 구성 요소로 테이블과 클리스터에 연관되어 독립적인 저장 공간을 보유하며, 데이터베이스에 저장된 자료를 더욱 빠르게 조회하기 위해서 사용되는 것\r\n",
		ITERATION: 202103,
		NO: 56,
		IS_CORRECT: "x",
		SUBJECT: 3,
	},
	{
		ANSWER: "ALTER",
		QUESTION:
			"회원 테이블 생성 후 주소 필드가 누락되어 이를 추가하려고 한다. 이에 적합한 SQL 명령어는?\r\n",
		ITERATION: 202103,
		NO: 58,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: "원자",
		QUESTION:
			"ㅇㅇ성; Commit과 Rollback 명령어에 의해 보장 받는 트랜잭션의 특징\r\n",
		ITERATION: 202008,
		NO: 43,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: "제외",
		QUESTION:
			"Division; Y ⊂ X인 두 개의 릴레이션 R(X), S(Y)이 있을 때, R의 속성이 S의 속성 값을 모두 가진 튜플에서 S가 가진 속성을 ㅇㅇ한 속성만을 구함.\r\n",
		ITERATION: 202008,
		NO: 52,
		IS_CORRECT: "x",
		SUBJECT: 3,
	},
	{
		ANSWER: "즉각 갱신",
		QUESTION:
			"ㅇㅇ ㅇㅇ 기법; 데이터베이스 로그(log)를 필요로 하는 회복 기법\r\n",
		ITERATION: 202008,
		NO: 54,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: 4,
		QUESTION:
			"트랜잭션의 연산은 데이터베이스에 모두 반영되든지 아니면 전혀 반영되지 않아야 한다는 트랜잭션 특성은?\r\n1)Durability    2)Share    3)Consistency    3)Atomicity\r\n",
		ITERATION: 202006,
		NO: 24,
		IS_CORRECT: "x",
		SUBJECT: 3,
	...
	},
	{
		ANSWER: "1, 1, 0",
		QUESTION:
			"다음 C언어의 변수 r1, r2, r3 값은?                   정답 기입 예시) 0, 0, 0\r\nint r1 = 4 <= 4 || 2 == 2;\r\nint r2 = (3 > 0) && (4 < 5);\r\nint r3 = !2;\r\n",
		ITERATION: 202108,
		NO: 66,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 196,
		QUESTION:
			"192.168.1.0/24 네트워크를 FLSM 방식을 이용하여 4개의 Subnet으로 나누고 IP Subnet-zero를 적용함. 이 때 Subnetting된 네트워크 중 4번째 네트워크의 4번째 사용 가능한 IP는 192.168.1.ㅇㅇㅇ임.                 정답 기입 예시) 111\r\n",
		ITERATION: 202108,
		NO: 69,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 4,
		QUESTION:
			"귀도 반 로섬이 발표한 언어로 인터프리터 방식이자 객체지향적이며, 배우기 쉽고 이식성이 좋은 것이 특징인 스크립트 언어는?\r\n1.C++    2.JAVA    3.C#    4.Python\r\n",
		ITERATION: 202108,
		NO: 72,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	{
		ANSWER: "OPT, FIFO, LRU, LFU, NUR, SCR",
		QUESTION:
	...
	},
	{
		ANSWER: 224,
		QUESTION:
			"CIDR(Classless Inter-Domain Routing) 표기로 203.241.132.82/27과 같이 사용되었다면, \r\n해당 주소의 서브넷 마스크(subnet mask)는?                   정답 기입 예시) 000\r\n-> 255.255.255.ㅇㅇㅇ\r\n",
		ITERATION: 202105,
		NO: 66,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	{
		ANSWER: "물리, 데이터, 네트워크, 전송, 세션, 표현, 응용",
		QUESTION:
	...
	},
	{
		ANSWER: 6,
		QUESTION:
			'기억 공간이 15K, 23K, 22K, 21K 순으로 빈 공간이 있을 때 기억 장치 배치 전력으로 "First Fit"을 사용하여 17K의 프로그램을 적재할 경우 내부단편화의 크기는?                            정답 기입 예시) 1\r\n-> ㅇK\r\n',
		ITERATION: 202103,
		NO: 65,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 4,
		QUESTION:
			"운영체제의 가상 기억 장치 관리에서 프로세스가 일정 시간 동안 자주 참조하는 페이지들의 집합을 의미하는 것은? \r\n1)Locality    2)Deadlock    3)Thrashing    4)Working Set\r\n",
		ITERATION: 202103,
		NO: 72,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 3,
		QUESTION:
			"TCP 흐름 제어 기법 중 프레임이 손실되었을 때, 손실된 프레임 1개를 전송하고 수신자의 응답을 기다리는 방식으로 한 번에 프레임 1개만 전송할 수 있는 기법은?\r\n1)Slow Start    2)Sliding Window    3)Stop and Wait    4)Congestion Avoidance\r\n",
		ITERATION: 202009,
		NO: 72,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 4,
		QUESTION:
			"응집도의 종류 중 서로 간에 어떠한 의미 있는 연관 관계도 지니지 않은 기능 요소로 구성되는 경위며, 서로 다른 상위 모듈에 의해 호출되어 처리 상의 연관성이 없는 서로 다른 기능을 수행하는 경우의 응집도는?\r\n1)Functional Cohesion    2)Sequential Cohesion    3)Logical Cohesion    4)Coincidental Cohesion\r\n",
		ITERATION: 202009,
		NO: 74,
		IS_CORRECT: "x",
		SUBJECT: 4,
	},
	{
		ANSWER: 398,
		QUESTION:
			"세그먼트 테이블에서 2번의 시작 주소는 222, 길이는 198임.\r\n논리주소(2, 176)에 대한 물리 주소는?\r\n",
		ITERATION: 202009,
		NO: 77,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: "절차",
		QUESTION:
			"ㅇㅇ적 응집도; 모듈이 다수의 관련 기능을 가질 때 모듈 안의 구성 요소들이 그 기능을 순차적으로 수행할 경우의 응집도\r\n",
		ITERATION: 202008,
		NO: 70,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"200.1.1.0/24 네트워크를 FLSM 방식을 이용하여 10개의 Subnet으로 나누고 ip subnet-zero를 적용함. 이때 서브네팅된 네트워크 중 10번째 네트워크의 broadcast IP 주소는?\r\n1)200.1.1.159    2)201.1.5.175    3)202.1.11.254    4)203.1.255.245\r\n",
		ITERATION: 202008,
		NO: 74,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 3,
		QUESTION:
			"어떤 모듈이 다른 모듈의 내부 논리 조직을 제어하기 위한 목적으로 제어 신호를 리용하여 통신하는 경우이며, 하위 모듈에서 상위 모듈로 제어 신호가 이동하여 상위 모듈에게 처리 명령을 부여하는 권리 전도 현상이 발생하게 되는 결합도는?\r\n1)data coupling    2)stamp coupling    3)control coupling    4)common coupling\r\n",
		ITERATION: 202008,
		NO: 77,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"은행가 알고리즘(Banker's Algorithm)은 교착 상태의 해결 방법 중 어떤 기법에 해당되는가?\r\n1)Avoidance    2)Detection    3)Prevention    4)Recovery\r\n",
		ITERATION: 202006,
		NO: 65,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: "전송",
		QUESTION:
			"ㅇㅇ 계층; OSI-7 계층에서 종단간 신뢰성 있고 효율적인 데이터를 전송하기 위해 오류 검출과 복구, 흐름 제어를 수행하는 계층\r\n",
		ITERATION: 202006,
		NO: 68,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 14,
		QUESTION:
			"페이지 참조 열 [7, 0, 1, 2, 0, 3, 0, 4, 2, 3, 0, 3, 2, 1, 2, 0, 1, 7, 0]에 대해 페이지 교체 기법으로 선입선출 알고리즘을 사용할 경우 페이지 부재 횟수는? (단, 할당된 페이지 프레임의 수는 3이고, 처음에는 모든 프레임이 비어 있음.)\r\n-> ㅇㅇ\r\n",
		ITERATION: 202006,
		NO: 77,
		IS_CORRECT: "x",
		SUBJECT: 4,
	...
	},
	{
		ANSWER: 1,
		QUESTION:
			"물리적 배치와 상관 없이 논리적으로 LAN을 구성하여 Broadcast Domain을 구분할 수 있게 해주는 기술로 접속된 장비들의 성능 향상 및 보안성 증대 효과가 있는 것은?\r\n1)VLAN    2)STP    3)L2AN    4)ARP\r\n",
		ITERATION: 202108,
		NO: 87,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: "MQTT",
		QUESTION:
			"ㅇㅇㅇㅇ; TCP/IP 기반 네트워크에서 동작하는 발행/구독 기반의 메시징 프로토콜로 최근 IoT 환경에서 자주 사용되고 있는 프로토콜\r\n",
		ITERATION: 202108,
		NO: 96,
		IS_CORRECT: "x",
		SUBJECT: 5,
	},
	{
		ANSWER: "SSO",
		QUESTION:
			"ㅇㅇㅇ; 시스템이 몇 대가 되어도 하나의 시스템에서 인증에 성공하면 다른 시스템에 대한 접근 권한도 얻는 시스템\r\n",
		ITERATION: 202108,
		NO: 97,
		IS_CORRECT: "x",
		SUBJECT: 5,
	},
	{
		ANSWER: "Salt",
		QUESTION:
			"ㅇㅇㅇㅇ; 시스템에 저장되는 패스워드들은 Hash 또는 암호화 알고리즘의 결과 값으로 저장됨. 이때 암호공격을 막기 위해 똑같은 패스워드들이 다른 암호 값으로 저장되도록 추가하는 값을 의미함.\r\n",
		ITERATION: 202108,
		NO: 98,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: "OWASP",
		QUESTION:
			"ㅇㅇㅇㅇㅇ; 오픈소스 웹 애플리케이션 보안 프로젝트로서 주로 웹을 통한 정보 유출, 악성 파일 및 스크립트, 보안 취약점 등을 연구하는 곳\r\n",
		ITERATION: 202108,
		NO: 100,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: "Sqoop",
		QUESTION:
			"ㅇㅇㅇㅇㅇ; 하둡(Hadoop)과 관계형 데이터베이스 간에 데이터를 전송할 수 있도록 설계된 도구\r\n",
		ITERATION: 202105,
		NO: 85,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: "ㅁ, ㅂ, ㅅ, ㄹ, ㄷ, ㄴ",
		QUESTION:
			"SPICE 모델의 프로세스 수행 능력 단계를 수준 0부터 수준 5까지 순서대로 말하시오.         정답 기입 예시) ㄱ, ㄴ, ㄷ, ㄹ, ㅁ, ㅂ\r\nㄱ)미완성 ㄴ)최적화 ㄷ)예측 ㄹ)확립 ㅁ)불완전 ㅂ)수행 ㅅ)관리\r\n",
		ITERATION: 202105,
		NO: 91,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: "nmap",
		QUESTION:
			"ㅇㅇㅇㅇ; 서버에 열린 포트 정보를 스캐닝해서 보안 취약점을 찾는데 사용하는 도구\r\n",
		ITERATION: 202105,
		NO: 98,
		IS_CORRECT: "x",
		SUBJECT: 5,
	},
	{
		ANSWER: "라우터",
		QUESTION:
			"ㅇㅇㅇ; 서로 다른 네트워크 대역에 있는 호스트들 상호 간에 통신할 수 있도록 해주는 네트워크 장비\r\n",
		ITERATION: 202105,
		NO: 99,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	{
		ANSWER: "표현, 비즈니스, 서비스, 전사, 운영",
		QUESTION:
			"서비스 지향 아키텍처(SOA)의 계층\r\n-> ㅇㅇ층, ㅇㅇㅇㅇ 프로세스층, ㅇㅇㅇ층, ㅇㅇ적 요소층, ㅇㅇ 시스템층\r\n",
		ITERATION: 202009,
		NO: 84,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	{
		ANSWER: "DFD, DD, 프로세스, ERD, STD, SADT",
		QUESTION:
	...
	},
	{
		ANSWER: "디지털 트윈",
		QUESTION:
			"물리적인 사물과 컴퓨터에 동일하게 표현되는 가상의 모델로, 실제 물리적인 자산 대신 소프트웨어로 가상화함으로써 실제 자산의 특성에 대한 정확한 정보를 얻을 수 있고, 자산 최적화, 돌발 사고 최소화, 생산성 증가 등 설계부터 제조, 서비스에 이르는 모든 과정의 효율성을 향상시킬 수 있는 모델은?\r\n-> ㅇㅇㅇ ㅇㅇ\r\n",
		ITERATION: 202008,
		NO: 81,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: "SLIM",
		QUESTION:
			"ㅇㅇㅇㅇ; Putnam 모형을 기초로 해서 만든 자동화 추정 도구\r\n",
		ITERATION: 202008,
		NO: 86,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: 4,
		QUESTION:
			"실무적으로 검증된 개발 보안 방법론 중 하나로, SW 보안의 모범 사례를 SDLC(Software Development Life Cycle)에 통합한 소프트웨어 개발 보안 생명주기 방법론은?\r\n1)CLASP    2)CWE    3)PIMS    4)Seven Touchpoints\r\n",
		ITERATION: 202008,
		NO: 92,
		IS_CORRECT: "x",
		SUBJECT: 5,
	...
	},
	{
		ANSWER: "무결",
		QUESTION:
			"ㅇㅇ성; 시스템 내의 정보는 오직 인가된 사용자만 수정할 수 있는 보안 요소\r\n",
		ITERATION: 202006,
		NO: 100,
		IS_CORRECT: "x",
		SUBJECT: 5,
